...
% as inputs and 'Breakpower' as output. Fuzzy rules are established to determine the
% appropriate break power based on the input conditions.
%
% Input Variables:
% 1. Distance [0 100] (small, medium, far, very_far, etc.)
% 2. Speed [0 120] (slow, medium, fast, very_fast)
%
% Output Variable:
% 1. Breakpower [0 100] (none, low, medium, high, very_high)
%
% =========================================================================================
...
% Estimated fis = addmf(fis, 'input', 1, 'very_far', 'trimf', [50 100 110]);
% Estimated
...
% Estimated fis = addmf(fis, 'input', 2, 'fast', 'trimf', [40 60 80]);
% Estimated fis = addmf(fis, 'input', 2, 'very_fast', 'trimf', [60 120 130]);
% Estimated
...
% Estimated fis = addmf(fis, 'output', 1, 'low', 'trimf', [0 25 50]);
        ...
        2 = OR ruleList =
            [1 1 2 1 1; % If Distance is small and
                ...
                Speed is slow then Breakpower is none %
                    Add more rules as needed to complete the logic];
